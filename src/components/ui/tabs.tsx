...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-md bg-secondary p-1 text-muted-foreground overflow-x-auto scrollbar-hide w-full md:w-auto",
      className
    )}
    {...props}
  />
